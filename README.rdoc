== IMPORTANT: This fork is not maintained anymore, please use {the official devise_invitable}[https://github.com/scambra/devise_invitable] by {@scambra}[https://github.com/scambra] instead!
