== !!! WARNING !!! Please don't use this branch ("edge") directly, instead, use the master[http://github.com/rymai/devise_invitable/tree/master] branch. This branch will be removed as soon as Rails 3.0 will be released !!! WARNING !!!
