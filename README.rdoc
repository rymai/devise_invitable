...
== Installation for Rails ~> 3.0.0 and Devise ~> 1.1.0

This fork[http://github.com/rymai/devise_invitable] of DeviseInvitable only supports Rails ~> 3.0.0 and Devise ~> 1.1.0
...
This email includes a link to accept the invitation like <tt>/users/invitation/accept/:invitation_token</tt>.
